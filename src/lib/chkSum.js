// taken from  http://stackoverflow.com/questions/18638900/javascript-crc32
...
const checkSum = function(encrypted) {
	return b_crc32(encrypted);
};
const check = function(encrypted, chkSum) {
	return encrypted === chkSum;
};
